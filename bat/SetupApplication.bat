...
:: Android packaging
set AND_CERT_NAME="Randtronics"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\Randtronics.p12
...
set IOS_PROVISION=cert\Randtronics.mobileprovision
...
set APP_ID=air.Randtronics

:: Output packages
set DIST_PATH=dist
set DIST_NAME=Randtronics
